...
import { GuxTabsAdvanced } from '../gux-tabs-advanced-legacy';
import { GuxTabAdvanced } from '../gux-tab-advanced/gux-tab-advanced';
import { GuxTabAdvancedList } from '../gux-tab-advanced-list-legacy/gux-tab-advanced-list-legacy';
import { GuxTabAdvancedPanel } from '../gux-tab-advanced-panel-legacy/gux-tab-advanced-panel-legacy';
