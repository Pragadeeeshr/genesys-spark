...
/**
 * @slot tab-list - Slot for gux-tab-advanced-legacy-list element
 * @slot - collection of gux-tab-advanced-legacy-panel elements
 */

@Component({
  styleUrl: 'gux-tabs-advanced-legacy.scss',
